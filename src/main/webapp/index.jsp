...
<body>
	...
	<h1 style="color: red; font-size: 40px;" align="center">WE INTEGRATED NEXUS TO JENKINS and also final one</h1>
	<h1 style="color: pink; font-size: 70px;" align="center">WE INTEGRATED NEXUS TO JENKINS</h1>
